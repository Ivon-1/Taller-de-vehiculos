...
<div class="card shadow p-4">
    ...
    <form method="GET" class="mb-3 d-flex">
        ...
        <button type="submit" class="btn btn-primary me-2"><a href="{{route('vehiculos.buscar')}}">🔍 Buscar</a></button>
        ...
        <tbody>
            @foreach ($vehiculos as $vehiculo)
                <tr>
                    ...
                    <td>
                        <a href="{{ route('revisiones.create', $vehiculo) }}" class="btn btn-warning">Pasar Revisión</a>
