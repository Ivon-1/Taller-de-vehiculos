...
<div class="card shadow p-4">
    ...
    <form method="POST" action="{{ route('revisiones.store', $vehiculo->id) }}">
        @csrf
        <div class="mb-3">
    ...
    <a href="{{ route('revisiones.historial', $vehiculo) }}" class="btn btn-secondary mt-3">⬅ Volver al Historial</a>
</div>
@endsection
